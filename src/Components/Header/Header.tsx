...
export const Header = () => {
    ...
    return <header className=" fixed top-5 left-0 w-full ">
        <div className='container relative flex justify-between items-center max-lg:flex-col max-lg:gap-6'>
            ...
            <button className='text-white font-bold-Qanelas px-[47px] max-xl:px-[28px] max-lg:px-[24.2px] max-md:px-[11px] py-[13px] max-xl:py-[10px] max-lg:py-[8px] max-md:py-[2px] bg-vivid-blue rounded-[10px] max-lg:absolute max-lg:right-4 max-lg:top-0' onClick={() => setAuthModal(true)}>Войти</button>
        </div>
        {authModal && (
